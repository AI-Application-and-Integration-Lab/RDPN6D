...
data_dir = osp.normpath(
    osp.join(PROJ_ROOT, "datasets/BOP_DATASETS/icbin/train_pbr"))

cls_indexes = sorted(id2obj.keys())
cls_names = [id2obj[cls_idx] for cls_idx in cls_indexes]
tless_model_dir = osp.normpath(
    osp.join(PROJ_ROOT, "datasets/BOP_DATASETS/icbin/models"))
model_paths = [
...
xyz_root = osp.normpath(
    osp.join(PROJ_ROOT, "datasets/BOP_DATASETS/icbin/train_pbr/xyz_crop"))
...
if __name__ == "__main__":
    ...
    setproctitle.setproctitle(
        f"gen_xyz_icbin_train_pbr_{args.split}_{args.scene}")
