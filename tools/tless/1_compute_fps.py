...
model_dir = ref.tless_full.model_reconst_dir
id2obj = ref.tless_full.id2obj
...
def main():
    ...
    for obj_id in tqdm(id2obj):
        ...
        fps_dict[str(obj_id)] = {}
        fps_dict[str(obj_id)]["fps2_and_center"] = get_fps_and_center(
            model["pts"], num_fps=2, init_center=True)
