...
xyz_root = osp.normpath(
    osp.join(PROJ_ROOT, "datasets/BOP_DATASETS/hb/train_pbr/xyz_crop"))
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="gen hb train_pbr xyz")
    ...
    setproctitle.setproctitle(
        f"gen_xyz_hb_train_pbr_{args.split}_{args.scene}")
