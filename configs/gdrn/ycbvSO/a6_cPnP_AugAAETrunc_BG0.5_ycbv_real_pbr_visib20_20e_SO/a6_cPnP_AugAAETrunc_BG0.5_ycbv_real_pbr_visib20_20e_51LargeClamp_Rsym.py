...
OUTPUT_DIR = "output/gdrn/ycbvSO/a6_cPnP_AugAAETrunc_BG0.5_ycbv_real_pbr_visib20_20e_SO/51"
INPUT = dict(
    DZI_PAD_SCALE=1.5,
    TRUNCATE_FG=True,
    CHANGE_BG_PROB=0.5,
...
DATASETS = dict(
    TRAIN=("ycbv_051_large_clamp_train_real",
           "ycbv_051_large_clamp_train_pbr"),
    TEST=("ycbv_test",),
    # # AP    AP50  AR    inf.time
