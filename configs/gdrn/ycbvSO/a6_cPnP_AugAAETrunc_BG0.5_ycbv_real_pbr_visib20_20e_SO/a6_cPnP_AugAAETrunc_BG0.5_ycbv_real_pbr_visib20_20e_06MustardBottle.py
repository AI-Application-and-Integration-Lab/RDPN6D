...
OUTPUT_DIR = "output/gdrn/ycbvSO/a6_cPnP_AugAAETrunc_BG0.5_ycbv_real_pbr_visib20_20e_SO/06"
INPUT = dict(
    DZI_PAD_SCALE=1.5,
    TRUNCATE_FG=True,
    CHANGE_BG_PROB=0.5,
...
DATASETS = dict(
    TRAIN=("ycbv_006_mustard_bottle_train_real",
           "ycbv_006_mustard_bottle_train_pbr"),
    TEST=("ycbv_test",),
    # # AP    AP50  AR    inf.time
