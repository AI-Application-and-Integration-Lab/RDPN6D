...
OUTPUT_DIR = "output/gdrn/ycbvSO/a6_cPnP_AugAAETrunc_BG0.5_ycbv_real_pbr_visib20_20e_SO/21"
INPUT = dict(
    DZI_PAD_SCALE=1.5,
    TRUNCATE_FG=True,
    CHANGE_BG_PROB=0.5,
...
DATASETS = dict(
    TRAIN=("ycbv_021_bleach_cleanser_train_real",
           "ycbv_021_bleach_cleanser_train_pbr"),
    TEST=("ycbv_test",),
    # # AP    AP50  AR    inf.time
