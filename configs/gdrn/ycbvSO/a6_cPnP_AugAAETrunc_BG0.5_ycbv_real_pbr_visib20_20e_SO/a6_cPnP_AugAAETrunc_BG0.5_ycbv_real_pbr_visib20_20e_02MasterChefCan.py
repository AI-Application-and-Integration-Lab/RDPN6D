...
OUTPUT_DIR = "output/gdrn/ycbvSO/a6_cPnP_AugAAETrunc_BG0.5_ycbv_real_pbr_visib20_20e_SO/02"
INPUT = dict(
    DZI_PAD_SCALE=1.5,
    TRUNCATE_FG=True,
    CHANGE_BG_PROB=0.5,
...
DATASETS = dict(
    TRAIN=("ycbv_002_master_chef_can_train_real",
    ...
    DET_FILES_TEST=(
        ...
        "datasets/BOP_DATASETS/ycbv/test/test_bboxes/test_ycbv_real.json",
    ),
    DET_THR=0.3,
