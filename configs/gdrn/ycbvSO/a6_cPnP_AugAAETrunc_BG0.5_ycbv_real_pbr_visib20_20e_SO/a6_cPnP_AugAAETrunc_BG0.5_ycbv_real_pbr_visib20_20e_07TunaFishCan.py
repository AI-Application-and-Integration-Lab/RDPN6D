...
OUTPUT_DIR = "output/gdrn/ycbvSO/a6_cPnP_AugAAETrunc_BG0.5_ycbv_real_pbr_visib20_20e_SO/07"
INPUT = dict(
    DZI_PAD_SCALE=1.5,
    TRUNCATE_FG=True,
    CHANGE_BG_PROB=0.5,
...
DATASETS = dict(
    TRAIN=("ycbv_007_tuna_fish_can_train_real",
           "ycbv_007_tuna_fish_can_train_pbr"),
    TEST=("ycbv_test",),
    # # AP    AP50  AR    inf.time
