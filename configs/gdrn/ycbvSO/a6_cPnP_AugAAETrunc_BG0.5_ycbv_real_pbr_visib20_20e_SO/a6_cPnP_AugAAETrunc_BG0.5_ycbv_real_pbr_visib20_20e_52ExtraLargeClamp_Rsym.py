...
OUTPUT_DIR = "output/gdrn/ycbvSO/a6_cPnP_AugAAETrunc_BG0.5_ycbv_real_pbr_visib20_20e_SO/52"
INPUT = dict(
    DZI_PAD_SCALE=1.5,
    TRUNCATE_FG=True,
    CHANGE_BG_PROB=0.5,
...
DATASETS = dict(
    TRAIN=("ycbv_052_extra_large_clamp_train_real",
           "ycbv_052_extra_large_clamp_train_pbr"),
    TEST=("ycbv_test",),
    # # AP    AP50  AR    inf.time
    ...
    DET_FILES_TEST=(
        ...
        "datasets/BOP_DATASETS/ycbv/test/test_bboxes/posecnn.json",
    ),
    SYM_OBJS=["024_bowl", "036_wood_block", "051_large_clamp",
              "052_extra_large_clamp", "061_foam_brick"],  # ycbv
)
