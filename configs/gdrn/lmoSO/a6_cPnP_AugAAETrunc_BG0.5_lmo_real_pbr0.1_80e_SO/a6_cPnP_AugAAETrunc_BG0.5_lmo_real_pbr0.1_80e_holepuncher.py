...
OUTPUT_DIR = "output/gdrn/lmoSO/a6_cPnP_AugAAETrunc_lmo_real_pbr0.1_80e_SO/holepuncher_only2D2"
INPUT = dict(
    DZI_PAD_SCALE=1.5,
    TRUNCATE_FG=True,
    CHANGE_BG_PROB=0.5,
...
SOLVER = dict(
    ...
    OPTIMIZER_CFG=dict(_delete_=True, type="Ranger",
...
DATASETS = dict(
    TRAIN=("lm_real_holepuncher_all",),
    TRAIN2=("lmo_pbr_holepuncher_train",),
    TRAIN2_RATIO=0.1,
    TEST=("lmo_test",),
    # AP	AP50	AR	inf.time
    # 60.657	89.625	66.2	0.024449
    DET_FILES_TEST=(
        "datasets/BOP_DATASETS/lmo/test/test_bboxes/test.json",
    ),
)
